    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Gagal berbagi invoice: $e')),
        );
      }
    }
  }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(Formatters.currency(widget.cartState.total), 
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      children: [
                                        _buildInfoRow('No. Invoice', widget.invoiceNo, isPrimary: true),
                                        const SizedBox(height: 8),
                                        _buildInfoRow('Waktu', Formatters.dateTime(DateTime.now())),
                                        const SizedBox(height: 8),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text('Rincian Item', style: AppTextStyles.bodyMedium.copyWith(fontWeight: FontWeight.bold)),
                                  const SizedBox(height: 16),
                                  ...widget.cartState.items.map((item) => Padding(
                                    ...
                                    child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text('${item.quantity}x', style: AppTextStyles.bodyMedium.copyWith(color: AppColors.textTertiary)),
                                        ...
                                        Text(Formatters.currency(item.subtotal), style: AppTextStyles.bodyMedium),
                                      ],
                                    ),
                                  )).toList(),
                                ],
                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                  _buildSummaryRow('Subtotal', Formatters.currency(widget.cartState.subtotal)),
                                  const SizedBox(height: 8),
                                  _buildSummaryRow('Total', Formatters.currency(widget.cartState.total), isBold: true),
                                  const SizedBox(height: 8),
                                  _buildSummaryRow('Bayar (Tunai)', Formatters.currency(widget.cash)),
                                  const Divider(height: 24),
                                  _buildSummaryRow(
                                    'Kembalian', 
                                    Formatters.currency(widget.change), 
                                    isBold: true, 
                                    color: widget.change < 0 ? AppColors.error : AppColors.success
                                  ),
                                ],
                              ),
                            ),
                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        child: const Text('Transaksi Baru', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      ),
                    ),
                  ],
                ),
    ...
    return Row(
      ...
      children: [
        ...
        Text(value, style: isBold 
          ? AppTextStyles.titleMedium.copyWith(color: color ?? AppColors.textPrimary, fontWeight: FontWeight.bold)
    ...
    return Padding(
      ...
      child: Row(
        children: List.generate(40, (index) => Expanded(
          child: Container(
            color: index % 2 == 0 ? Colors.transparent : AppColors.border.withOpacity(0.5),
            height: 1,
          ),
        )),
      ),
